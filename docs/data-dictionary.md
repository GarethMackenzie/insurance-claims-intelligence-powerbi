...
| Investigation_Capacity_Pct | FraudCapacityScenario | int64 | Investigation capacity pct. | 5 | No | No | Generated from documented synthetic portfolio logic or dimension metadata. |
| Claims_Selected | FraudCapacityScenario | int64 | Claims selected. | 3750 | No | No | Generated from documented synthetic portfolio logic or dimension metadata. |
| Potential_Fraud_Captured | FraudCapacityScenario | int64 | Potential fraud captured. | 644 | No | No | Generated from documented synthetic portfolio logic or dimension metadata. |
| Review_Precision | FraudCapacityScenario | double | Review precision. | 0.1717 | No | No | Generated from documented synthetic portfolio logic or dimension metadata. |
| Fraud_Recall | FraudCapacityScenario | double | Fraud recall. | 0.0963 | No | No | Generated from documented synthetic portfolio logic or dimension metadata. |
| False_Positive_Rate | FraudCapacityScenario | double | False positive rate. | 0.8283 | No | No | Generated from documented synthetic portfolio logic or dimension metadata. |
| Lift_vs_Random | FraudCapacityScenario | double | Lift vs random. | 1.9270 | No | No | Generated from documented synthetic portfolio logic or dimension metadata. |
